        ...
        {brawler ? (
          ...
          >
            ...
            <button
              ...
              className="absolute -top-2 -right-2 z-10 bg-red-500 text-white rounded-none flex items-center justify-center hover:bg-red-600 transition-colors shadow-lg"
