    ...
    <Dialog>
      <DialogTrigger asChild>
        <Button 
          variant="ghost" 
          size="icon" 
          className="rounded-full bg-gray-800/50 hover:bg-gray-700/70 transition-all duration-300 my-[76px] px-0 mx-0"
          aria-label={isSpanish ? "Ayuda" : "Help"}
        >
          <img 
            src="/resources/iconInt.png" 
            alt={isSpanish ? "Ayuda" : "Help"}
            className="w-6 h-6 transition-transform duration-300 hover:scale-110"
          />
        </Button>
      </DialogTrigger>
      <DialogContent className="max-w-3xl max-h-[80vh] glass-panel border-none bg-gradient-to-br from-gray-900/90 to-gray-800/90 backdrop-blur-xl border border-white/10 text-white shadow-[0_0_15px_rgba(0,0,0,0.3)]">
        <DialogHeader>
        ...
        <ScrollArea className="pr-4 max-h-[60vh]">
          <div className="space-y-6 mt-2">
            {/* Introduction */}
            <div className="bg-gray-800/40 p-4 rounded-lg hover:bg-gray-700/50 transition-colors duration-300">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-800/40 p-4 rounded-lg hover:bg-gray-700/50 transition-colors duration-300 transform hover:translate-y-[-2px]">
                <div className="flex items-start">
                  <span className="bg-gradient-to-br from-blue-500 to-blue-700 text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 shrink-0 mt-0.5 shadow-md">1</span>
                  <div>
              ...
              <div className="bg-gray-800/40 p-4 rounded-lg hover:bg-gray-700/50 transition-colors duration-300 transform hover:translate-y-[-2px]">
                <div className="flex items-start">
                  <span className="bg-gradient-to-br from-blue-500 to-blue-700 text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 shrink-0 mt-0.5 shadow-md">2</span>
                  <div>
              ...
              <div className="bg-gray-800/40 p-4 rounded-lg hover:bg-gray-700/50 transition-colors duration-300 transform hover:translate-y-[-2px]">
                <div className="flex items-start">
                  <span className="bg-gradient-to-br from-blue-500 to-blue-700 text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 shrink-0 mt-0.5 shadow-md">3</span>
                  <div>
              ...
              <div className="bg-gray-800/40 p-4 rounded-lg hover:bg-gray-700/50 transition-colors duration-300 transform hover:translate-y-[-2px]">
                <div className="flex items-start">
                  <span className="bg-gradient-to-br from-blue-500 to-blue-700 text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 shrink-0 mt-0.5 shadow-md">4</span>
                  <div>
              ...
              <div className="bg-gray-800/40 p-4 rounded-lg hover:bg-gray-700/50 transition-colors duration-300 transform hover:translate-y-[-2px]">
                <div className="flex items-start">
                  <span className="bg-gradient-to-br from-blue-500 to-blue-700 text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 shrink-0 mt-0.5 shadow-md">5</span>
                  <div>
            ...
            {/* Phases */}
            <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 p-4 rounded-lg border border-blue-500/20 shadow-inner shadow-blue-500/5 hover:shadow-blue-500/10 transition-all duration-300">
            ...
            {/* Tips */}
            <div className="bg-gradient-to-br from-yellow-900/30 to-yellow-800/20 p-4 rounded-lg border border-yellow-500/30 shadow-lg transform transition-all duration-300 hover:translate-y-[-2px]">
