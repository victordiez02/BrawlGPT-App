      ...
      <div className="flex-1 flex flex-col items-center justify-center w-full max-w-7xl mx-auto px-4 py-12 md:py-24 relative z-10 overflow-hidden">
        <div className="w-full max-w-6xl">
          <div className="mb-16 text-center relative">
            ...
            {/* Title with BrawlGPT - COLORED SECTIONS WITH TEXT SHADOW */}
            ...
            <div className="max-w-3xl mx-auto">
              ...
              {/* Button with digital circuits design */}
              <div className="space-y-8">
                <Link to="/simulator" className="inline-block relative">
                  <Button variant="ai" size="lg" className="group relative px-12 py-8 text-xl font-medium font-brawl rounded-xl transition-all hover:scale-105 mx-auto text-shadow">
